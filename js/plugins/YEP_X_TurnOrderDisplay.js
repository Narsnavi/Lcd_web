 ...
 * @on YES
 * @off NO
 * @desc 如果使用动画SV敌人，如果没有使用图标，
 * 画出他们的战斗图？这会出现延迟. NO - false  YES - true
 * @default false
 *
 * @help
 * ============================================================================
 ...
 *
 * 对于像DTB(默认回合战斗)这样的基于回合的战斗系统，
 * 让玩家直观地看到回合顺序可以给战斗系统增加更多的深度。
 * 这个插件会在屏幕的一角添加一个图标显示
 * 玩家和敌人的回合顺序(可修改)。
 * ...
 *
 * 注意！这个插件不适用于基于时间的战斗系统，比如
 * ATB或CTB！它是专门为基于回合的战斗系统设计的。
 *
 * ============================================================================
 * 注释标记
 * ============================================================================
 *
 * 插入以下标签，给你的角色和敌人独特的回合顺序图标。
 * ...
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
 *
 ...
 *   - 这将角色/敌人使用的边框颜色设置为文本颜色x。
 *
 *   <Turn Order Background Color: x>
 *   - 这将角色/敌人使用的背景颜色设置为文本颜色x。
 *
 * - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
 *
 * Actor Only Notetags:
