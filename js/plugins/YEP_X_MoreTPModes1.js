...
//=============================================================================
 /*:
 * @plugindesc v1.01 增强TP拓展1(需要 YEP_EnhancedTP.js)
 * to your game!
 ...
 * @parent ---Mode 21 Settings---
 * @desc 用于此TP模式的第一个帮助描述行。
 * @default -
 *
 * @param Mode 21 Help Line 2
 * @parent ---Mode 21 Settings---
 * @desc 用于此TP模式的第二个帮助描述行。
 * @default -
 *
 * @param Mode 21 Max TP
 * @parent ---Mode 21 Settings---
 * @desc 用于确定该TP模式最大值的公式。
 * @default 100
 *
 * @param Mode 21 Preserve
 * @parent ---Mode 21 Settings---
 * @desc true - 携带TP从一场战斗到下一场战斗。
 * false - 每次战斗重置初始TP
 * @default true
 *
 ...
 * @parent ---Mode 21 Settings---
 * @desc 队友MP消耗获得多少TP的公式。
 * @default 0
 *
 * @param Mode 21 Deal State
 * @parent ---Mode 21 Settings---
 * @desc 当角色对敌人施加状态时获得TP的公式。
 * @default 0
 *
 * @param Mode 21 Gain State
 * @parent ---Mode 21 Settings---
 * @desc 当角色从敌人那里获得一个状态时获得TP的公式。
 * @default 0
 *
 ...
 * ============================================================================
 *
 * 这个插件需要YEP_EnhancedTP。
 * 确保该插件位于插件列表中的YEP _ EnhancedTP下。
 *
 * 如果你有其他的YEP _ X _ MoreTPModes插件，请按顺序放置它们。
 *
 * 对于那些认为20个TP模式不够的人，这将把你的游戏的
 * TP模式数量再增加20个，总共40个TP模式！
 * 
 * ============================================================================
 * Changelog
 * ============================================================================
