...
//=============================================================================
 /*:
 * @plugindesc v1.61 核心代码升级及优化(需要 YEP_CoreEngine.js)
 ...
 *
 * 该插件需要以下内容:
 * - 安装了YEP _ CoreEngine插件
 * - 在YEP_CoreEngine下安装此插件
 * - RPG Maker MV版本基本代码1.4.0或以上
 * - 遵循帮助文件的"Instructions"部分中列出的说明
 *
 * 你的游戏项目至少有基础代码(rpg_x.js) 1.4.0以上吗？
 * RPG Maker MV更新过了吗，但是你不想手动更新基本
 * 代码，可能是因为你对代码本身做了一些编辑？
 * 然而，您仍然想利用版本ups的变化吗？
 * 这个插件将为你处理这个问题，同时保持你的基本代码不变，
 * 同时'patching'从更高版本的ups所做的更改。
 *
 * 该插件还添加了1.5.2之前版本的更新和新功能，
 * 以确保您的项目即使运行1.4.0也具有最新的功能。
 * 这样，您就不必自己篡改游戏项目的基本代码文件。
 * ...
 *
 * 注意:你仍然需要下载最新的Pixi库，并使用这个插件来
 * 正常工作。更多将在这个插件的帮助文件下的说明部分
 * 解释。
 *
 * ============================================================================
 * 指令
 * ============================================================================
 *
 * 如果您有一个需要更新的旧项目，请执行以下操作:
 *
 * 1. 备份您的项目。
 * 2. 创建一个新项目或转到您的RPG Maker MV根文件夹
 *    (安装RPG Maker MV的位置)中的"NewData"文件夹。
 * 3. 复制" js "下的" libs "文件夹，并替换旧项目中的文件夹。
 * 4. 将新的index.html文件复制到您当前的项目中。
 * 5. 更新gamefont.css以防万一。
 * 6. 请确保您安装了最新版本的YEP _ CoreEngine.js。
 * 7. 在游戏项目的插件管理器列表中，在YEP _ CoreEngine
 *    下安装YEP _ X _ CoreUpdatesOpt.js(这个插件)。
 * 8. 运行你的游戏！
 *
 * ============================================================================
 * 桌面优化选项
 * ============================================================================
 *
 * 这个插件还包括Yanfly的桌面优化基础代码的变化，
 * 为那些希望优化他们的项目，主要是桌面游戏的人。
 * 这样一个选项背后的原因是，自从1.5.0更新以来，
 * RPG Maker MV整体上给编辑器增加了很多精彩的新特性。
 * 然而，基本代码已经更新，使得RPG Maker MV游戏比
 * 桌面游戏更有利于移动游戏优化。因此，运行在1.5.0及
 * 以上版本的RPG Maker MV游戏在加载图像时会出现奇
 * 怪的问题，这与1.4.0及以下版本不同。.
 *
 * 该功能是RPG Maker MV最新版本的混合，利用了更适
 * 合桌面优化的1.4.0源代码。这样，对于主要针对桌面游
 * 戏开发的开发人员来说，您的游戏将像使用1.4.0基本代
 * o码一样运行，同时能够充分利用最新更新的RPG Maker
 * MV版本的功能！
 * ...
 *
 * ============================================================================
 ...
 * @on YES
 * @off NO
 * @desc 将1.0.0更新添加到1.1.0？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 120_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.1.0更新添加到1.2.0？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 130_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.2.0更新添加到1.3.0？如果检测到更高版本，
 * 将1.2.0更新添加到1.3.0？如果检测到更高版本，
 * @default true
 *
 * @param 131_Updates
 * @text 1.3.0 to 1.3.1
 ...
 * @on YES
 * @off NO
 * @desc 将1.3.0更新添加到1.3.1？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 132_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.3.1更新添加到1.3.2？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 133_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.3.2更新添加到1.3.3？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 134_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.3.3添加到1.3.4更新？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 140_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.3.4更新添加到1.4.0？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 150_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.4.0更新添加到1.5.0？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 151_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.5.0更新添加到1.5.1？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param 152_Updates
 ...
 * @on YES
 * @off NO
 * @desc 将1.5.1更新添加到1.5.2？如果检测到更高版本，
 * 将1.5.1更新添加到1.5.2？如果检测到更高版本，
 * @default true
 *
 * @param 162_Updates
 * @text 1.5.2 to 1.6.1
 ...
 * @on YES
 * @off NO
 * @desc 将1.5.2更新添加到1.6.1？如果检测到更高版本，
 * 此功能将被自动禁用。
 * @default true
 *
 * @param ---Custom---
